...
export const FALLBACK_COURSE_MAP = {
  'surveying-package': {
    ...
    usefulness: [
      'تطبيق عملي مباشر في جميع مشاريع البناء والإنشاء',
    ...
    content: [
      'مقدمة في أعمال المساحة وأنواع الرفع المختلفة',
      'التدريب على جهاز الميزان والتوتال ستيشن',
      'تطبيقات عملية داخل الموقع',
      'معالجة البيانات وتجهيز الملفات',
    ],
    benefits: [
      'شهادة حضور',
  ...
  autocad: {
    ...
    content: [
      'التعرف على واجهة AutoCAD',
      'أوامر الرسم والتعديل الأساسية',
      'الطبقات والأبعاد',
      'إخراج اللوحات والطباعة',
    ],
    benefits: [
      'مشاريع تطبيقية',
      'شهادة حضور',
  ...
  'civil-3d': {
    ...
    content: [
      'مقدمة في Civil 3D',
      'إنشاء الأسطح والمحاور',
      'إعداد المقاطع والكميات',
      'تطبيقات تصميمية عملية',
    ],
    benefits: [
      'مشروعات تطبيقية',
