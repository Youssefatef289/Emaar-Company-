...
const FloatingContactButton = () => {
  ...
  const contactLinks = [
    ...
    },
    {
      name: 'فيسبوك',
      icon: FaFacebook,
      href: 'https://www.facebook.com/share/18Aw9QebCy/',
    ...
    },
    {
      name: 'إنستجرام',
      icon: FaInstagram,
      href: 'https://www.instagram.com/emaarcompany1?igsh=MTF4NmJ2dWJvd3huNQ==',
    ...
    },
    {
      name: 'يوتيوب',
      icon: FaYoutube,
      href: 'https://youtube.com/channel/UCZfRI4IthrN74NOuJO-KVzw?si=6WRGbj5O4mRQ4699',
      color: 'youtube-color',
